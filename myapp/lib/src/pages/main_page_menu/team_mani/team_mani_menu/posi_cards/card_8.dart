                  ...
                  itemBuilder: (context, i){
                    return ListTile(
                      ...
                      onTap: ()  async {
                        ...
                        if(context.read<state_team_mani.Store3>().card8['name']!=''){
                          //카드에서 삭제한 선수 positioned true로 바꾸기(선수 선택 리스트에 추가)
                          await context.read<state_team_mani.Store3>().changePositioned2(context.read<state_team_mani.Store3>().card8);
                        }
                        //카드에 선수 이름 추가
                        context.read<state_team_mani.Store3>().changeCard8('name',context.read<state_team_mani.Store3>().bottomlist(1)[i]['name']);
                        //카드에 선수 등번호 추가
                        context.read<state_team_mani.Store3>().changeCard8('number',context.read<state_team_mani.Store3>().bottomlist(1)[i]['number']);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //선수 이름
            Text(
              context.watch<state_team_mani.Store3>().card8['name'].toString(),
              style: TextStyle(fontSize: 15),
            ),
            //등번호
            Text(
